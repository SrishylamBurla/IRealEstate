...
export default function AgentProfile({ user }) {
  return (
    <div className="space-y-10">
      {/* 🟦 PROFILE HEADER */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#042e26] via-slate-900 to-[#4f1960] p-8 text-white shadow-xl">
        {/* subtle overlay */}
